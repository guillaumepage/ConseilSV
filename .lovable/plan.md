# Plan — Portail ConseilSV

Création d'un portail sécurisé "ConseilSV" qui sert de porte d'entrée vers VacciCheck (https://vaccicheckapp.netlify.app/) et centralise les ressources vaccination/santé voyage (INSPQ, PIQ, RxVigilance).
...
/_authenticated/
  /dashboard   Page d'accueil après login : 3 cartes
                 ...
                 - RxVigilance (formulaires PDF intégrés)
...
- Typo moderne (Inter)
- Logo ConseilSV intégré comme asset, affiché sur landing + auth + header
